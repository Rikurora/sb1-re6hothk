...
import { Shield, FileText, Users, AlertTriangle, Download, CheckCircle, Clock, XCircle } from 'lucide-react';

const BiosafetyCoun: React.FC = () => {
  ...
  const applicationTypes = [
    {
      type: "Contained Use",
      description: "Laboratory research involving genetically modified organisms in contained facilities",
      timeline: "30-45 days",
      fee: "N$2,500",
      requirements: ["Risk assessment", "Containment measures", "Waste management plan"]
    },
    {
      type: "Deliberate Release",
      description: "Field trials and environmental release of genetically modified organisms",
      timeline: "90-120 days",
      fee: "N$15,000",
      requirements: ["Environmental risk assessment", "Monitoring plan", "Emergency response plan"]
    },
    {
      type: "Import/Export",
      description: "Import or export of genetically modified organisms and products",
      timeline: "14-21 days",
      fee: "N$1,000",
      requirements: ["Product documentation", "Country of origin permits", "Transport protocols"]
    },
    {
      type: "Commercial Use",
      ...
      fee: "N$25,000",
      requirements: ["Comprehensive risk assessment", "Labeling plan", "Post-market monitoring"]
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "Biosafety refers to the safe handling, use, and management of biological materials, particularly genetically modified organisms (GMOs), to prevent adverse effects on human health and the environment."
    },
    {
      question: "Do I need a permit for all GMO-related activities?",
      answer: "Yes, the Biosafety Act requires permits for contained use, deliberate release, import/export, and commercial use of GMOs. Exemptions may apply for certain research activities."
    },
    {
      question: "How long does the permit application process take?",
      answer: "Processing times vary by application type: Import/Export (14-21 days), Contained Use (30-45 days), Deliberate Release (90-120 days), Commercial Use (120-180 days)."
    },
    {
      question: "What happens if I conduct GMO activities without a permit?",
      answer: "Unauthorized GMO activities are illegal under the Biosafety Act and may result in fines, imprisonment, and immediate cessation of activities."
    },
    {
      question: "Can I appeal a permit decision?",
      answer: "Yes, applicants have the right to appeal permit decisions to the Minister within 30 days of receiving the decision."
    }
  ];
  ...
  const downloadableForms = [
    ...
    },
    {
      ...
      description: "Comprehensive guide for conducting biosafety risk assessments",
      fileType: "PDF",
      size: "4.5 MB"
    },
    {
  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto leading-body opacity-90">
              Ensuring the safe development, handling, and use of genetically modified organisms to protect human health and the environment.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-ncrst-grey mb-4 leading-heading">Regulatory Framework</h2>
            <p className="text-lg text-ncrst-grey-dark max-w-3xl mx-auto leading-body">
              Comprehensive biosafety regulation based on international best practices and scientific risk assessment.
            </p>
          </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8">
              ...
              <div className="space-y-4">
                <p className="text-ncrst-grey-dark leading-body">
                  The Biosafety Act provides the legal framework for regulating genetically modified organisms in Namibia, ensuring safety while promoting beneficial biotechnology applications.
                </p>
                <div>
                  <h4 className="font-semibold text-ncrst-grey mb-2">Key Provisions</h4>
            ...
            <div className="bg-ncrst-green text-white rounded-xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Science-Based Assessment</h4>
                    <p className="text-sm opacity-90">Decisions based on rigorous scientific risk assessment</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="bg-white/20 rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">Precautionary Approach</h4>
                    <p className="text-sm opacity-90">Caution when scientific evidence is insufficient</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="bg-white/20 rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-90">Open and transparent decision-making process</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="bg-white/20 rounded-full w-6 h-6 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-90">Meaningful stakeholder engagement and consultation</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-ncrst-grey-light rounded-xl p-8">
            <h3 className="text-xl font-bold text-ncrst-grey mb-6 leading-heading">Permit Application Types</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {applicationTypes.map((app, index) => (
                <div key={index} className="bg-white p-6 rounded-lg shadow-sm">
                  <h4 className="font-bold text-ncrst-grey mb-2 leading-heading">{app.type}</h4>
                  <p className="text-sm text-ncrst-grey-dark mb-4 leading-body">{app.description}</p>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-ncrst-grey-dark">Processing time:</span>
                      <span className="font-medium text-ncrst-grey">{app.timeline}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-ncrst-grey-dark">Application fee:</span>
                      <span className="font-medium text-ncrst-grey">{app.fee}</span>
                    </div>
                  </div>
                  <div className="mt-4">
                    <h5 className="font-medium text-ncrst-grey mb-2">Key Requirements:</h5>
      ...
      <section className="py-16 bg-ncrst-grey-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-ncrst-grey mb-4 leading-heading">National Biosafety Committee</h2>
            <p className="text-lg text-ncrst-grey-dark max-w-3xl mx-auto leading-body">
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg p-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-ncrst-blue font-medium">{member.role}</p>
                  </div>
                </div>
                <div className="space-y-2 text-sm">
                  <div>
                  ...
                  <div>
                    <span className="font-medium text-ncrst-grey">Institution: </span>
                    <span className="text-ncrst-grey-dark">{member.institution}</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h3 className="text-xl font-bold text-ncrst-grey mb-6 leading-heading">Committee Functions</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className="font-semibold text-ncrst-grey mb-3">Advisory Functions</h4>
              ...
              <div>
                <h4 className="font-semibold text-ncrst-grey mb-3">Regulatory Support</h4>
                <ul className="space-y-2 text-sm text-ncrst-grey-dark">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-ncrst-grey mb-4 leading-heading">Application Process & Forms</h2>
            <p className="text-lg text-ncrst-grey-dark max-w-3xl mx-auto leading-body">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {downloadableForms.map((form, index) => (
              <div key={index} className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-ncrst-green hover:shadow-lg transition-all">
                ...
                <h3 className="text-lg font-bold text-ncrst-grey mb-3 leading-heading">{form.title}</h3>
                <p className="text-sm text-ncrst-grey-dark mb-4 leading-body">{form.description}</p>
          ...
          <div className="bg-ncrst-blue text-white rounded-xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm opacity-90">Complete forms and documents</p>
              </div>
              <div className="text-center">
                <div className="bg-white/20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-sm opacity-90">Expert committee assessment</p>
              </div>
              <div className="text-center">
                <div className="bg-white/20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                ...
                <p className="text-sm opacity-90">Stakeholder input (if required)</p>
              </div>
              <div className="text-center">
                <div className="bg-white/20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
      ...
      <section className="py-16 bg-ncrst-grey-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-ncrst-grey mb-4 leading-heading">Recent Permit Decisions</h2>
            <p className="text-lg text-ncrst-grey-dark max-w-3xl mx-auto leading-body">
                  ...
                  {recentDecisions.map((decision, index) => (
                    <tr key={index} className="hover:bg-gray-50">
                      <td className="px-6 py-4">
                        <div className="font-medium text-ncrst-grey">{decision.applicant}</div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="text-sm text-ncrst-grey-dark">{decision.activity}</div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="text-sm text-ncrst-grey">{decision.decision}</div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="text-sm text-ncrst-grey-dark">{decision.date}</div>
                      </td>
                      <td className="px-6 py-4">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                          decision.status === 'approved' ? 'bg-green-100 text-green-800' :
                          decision.status === 'conditional' ? 'bg-yellow-100 text-yellow-800' :
                          decision.status === 'pending' ? 'bg-blue-100 text-blue-800' :
                          'bg-red-100 text-red-800'
                        }`}>
                          {decision.status === 'approved' && <CheckCircle size={12} className="mr-1" />}
                          {decision.status === 'conditional' && <AlertTriangle size={12} className="mr-1" />}
                          {decision.status === 'pending' && <Clock size={12} className="mr-1" />}
                          {decision.status === 'rejected' && <XCircle size={12} className="mr-1" />}
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-ncrst-grey mb-4 leading-heading">Frequently Asked Questions</h2>
            <p className="text-lg text-ncrst-grey-dark max-w-3xl mx-auto leading-body">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white border-2 border-gray-200 rounded-xl p-6">
                <h3 className="text-lg font-bold text-ncrst-grey mb-3 leading-heading">{faq.question}</h3>
                <p className="text-ncrst-grey-dark leading-body">{faq.answer}</p>
              </div>
            ))}
          </div>
