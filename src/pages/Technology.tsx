...
import { Brain, Microscope, Database, Cpu, Download, Users, BarChart, FileText, Shield, Rocket } from 'lucide-react';
...
const Technology: React.FC = () => {
  const aiInitiatives = [
    ...
    },
    {
      ...
      description: "Capacity building programs for students, researchers, and industry professionals",
  ...
  const techResources = [
    ...
    },
    {
      ...
      description: "Market analysis and investment landscape in Namibian biotech",
      type: "Report",
      size: "5.8 MB",
      downloads: "890"
    },
    {
      ...
      description: "Strategic framework for digital adoption in various sectors",
      type: "Whitepaper",
      size: "2.1 MB",
      downloads: "2,150"
    }
  ...
  return (
    <div>
      {/* Page Header */}
      <section className="bg-ncrst-grey text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto leading-body opacity-90">
              Advancing Namibia's technological capabilities through cutting-edge research, world-class laboratories, and strategic innovation initiatives.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="ai" className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-ncrst-grey mb-4 leading-heading">National AI Working Group</h2>
            <p className="text-lg text-ncrst-grey-dark max-w-3xl mx-auto leading-body">
              Leading artificial intelligence research and development initiatives to transform key sectors of the Namibian economy.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-lg mb-6 opacity-90 leading-body">
                  The National AI Working Group brings together researchers, industry experts, and innovators to harness the power of artificial intelligence for national development.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {aiInitiatives.map((initiative, index) => (
              <div key={index} className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-ncrst-blue hover:shadow-lg transition-all">
                ...
                <h3 className="text-lg font-bold text-ncrst-grey mb-3 leading-heading">{initiative.title}</h3>
                <p className="text-ncrst-grey-dark mb-4 leading-body">{initiative.description}</p>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-ncrst-grey-dark">Participants:</span>
                    <span className="font-medium text-ncrst-grey">{initiative.participants}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-ncrst-grey-dark">Active:</span>
                    <span className="font-medium text-ncrst-grey">{initiative.projects}</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="bg-ncrst-grey-light rounded-xl p-8">
            <h3 className="text-xl font-bold text-ncrst-grey mb-6 leading-heading">AI Research & Reports</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="flex items-center space-x-3 mb-4">
                  <FileText className="text-ncrst-blue" size={24} />
                  <h4 className="font-semibold text-ncrst-grey">National AI Strategy 2024</h4>
                </div>
                <p className="text-sm text-ncrst-grey-dark mb-4 leading-body">
                  Comprehensive roadmap for AI development and adoption across Namibian sectors.
                </p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h4 className="font-semibold text-ncrst-grey">AI Impact Assessment</h4>
                </div>
                <p className="text-sm text-ncrst-grey-dark mb-4 leading-body">
                  Analysis of AI implementation outcomes in agriculture and healthcare sectors.
                </p>
                <button className="flex items-center space-x-2 text-ncrst-blue hover:text-ncrst-green transition-colors">
                  <Download size={16} />
                  <span className="text-sm font-medium">Download Report</span>
      ...
      <section id="biotech" className="py-16 bg-ncrst-grey-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-ncrst-grey mb-4 leading-heading">Biotechnology Laboratories</h2>
            <p className="text-lg text-ncrst-grey-dark max-w-3xl mx-auto leading-body">
              State-of-the-art laboratory facilities providing specialized services for research, industry, and regulatory compliance.
            </p>
          </div>
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-ncrst-grey mb-2">Services Offered</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-ncrst-grey mb-2">Equipment</h4>
                      <p className="text-sm text-ncrst-grey-dark">{lab.equipment}</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-ncrst-grey mb-2">Certification</h4>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h3 className="text-xl font-bold text-ncrst-grey mb-6 text-center leading-heading">Laboratory Services & Capabilities</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Database className="text-blue-600" size={24} />
                </div>
                <h4 className="font-semibold text-ncrst-grey mb-2">Genetic Analysis</h4>
                <p className="text-sm text-ncrst-grey-dark">DNA sequencing and genetic profiling services</p>
              </div>
              <div className="text-center">
                <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Microscope className="text-green-600" size={24} />
                </div>
                <h4 className="font-semibold text-ncrst-grey mb-2">Biosafety Testing</h4>
                <p className="text-sm text-ncrst-grey-dark">GMO detection and environmental risk assessment</p>
              </div>
              <div className="text-center">
                <div className="bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Cpu className="text-purple-600" size={24} />
                </div>
                <h4 className="font-semibold text-ncrst-grey mb-2">Food Safety</h4>
                <p className="text-sm text-ncrst-grey-dark">Contamination testing and quality assurance</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-ncrst-grey-dark">Laboratory techniques and biosafety protocols</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="biosafety" className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-ncrst-grey mb-4 leading-heading">Biosafety</h2>
            <p className="text-lg text-ncrst-grey-dark max-w-3xl mx-auto leading-body">
            ...
            <div className="bg-ncrst-green text-white rounded-xl p-8">
              ...
              <div className="space-y-4">
                <p className="opacity-90 leading-body">
                  NCRST regulates biotechnology activities through comprehensive biosafety assessment and monitoring programs.
                </p>
      ...
      <section id="sst" className="py-16 bg-ncrst-grey-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-ncrst-grey mb-4 leading-heading">Space Science and Technology (SST)</h2>
            <p className="text-lg text-ncrst-grey-dark max-w-3xl mx-auto leading-body">
              Advancing Namibia's space science capabilities and leveraging space technology for national development.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl p-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm opacity-90">Development of Namibia's first satellite for earth observation</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Dark Sky Initiative</h4>
                  <p className="text-sm opacity-90">Protecting exceptional night skies for astronomical research</p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Space Weather Monitoring</h4>
                  <p className="text-sm opacity-90">Real-time monitoring of space weather effects</p>
                </div>
              </div>
            </div>

            <div className="bg-white border-2 border-gray-200 rounded-xl p-8">
              <h3 className="text-xl font-bold text-ncrst-grey mb-6 leading-heading">Space Science Applications</h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-purple-600 rounded-full mt-2"></div>
                  <div>
                    <h4 className="font-semibold text-ncrst-grey">Earth Observation</h4>
                    <p className="text-sm text-ncrst-grey-dark">Satellite monitoring for agriculture and environment</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-purple-600 rounded-full mt-2"></div>
                  <div>
                    <h4 className="font-semibold text-ncrst-grey">Communications</h4>
                    <p className="text-sm text-ncrst-grey-dark">Satellite communication services for remote areas</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-purple-600 rounded-full mt-2"></div>
                  <div>
                    <h4 className="font-semibold text-ncrst-grey">Navigation</h4>
                    <p className="text-sm text-ncrst-grey-dark">GPS and positioning services enhancement</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="resources" className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-ncrst-grey mb-4 leading-heading">Technology Resources</h2>
            <p className="text-lg text-ncrst-grey-dark max-w-3xl mx-auto leading-body">
              Access comprehensive guides, reports, and resources to support technology adoption and innovation.
            </p>
          </div>
          ...
          <div className="bg-ncrst-blue text-white rounded-xl p-8">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4 leading-heading">Technology Partnerships</h3>
              <p className="text-lg opacity-90 max-w-3xl mx-auto leading-body">
                Collaborating with leading institutions and organizations to advance Namibia's technological capabilities.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm opacity-90">Research collaboration with local and international universities</p>
              </div>
              <div className="text-center">
                <div className="bg-white/10 p-4 rounded-lg mb-3">
                  <h4 className="font-bold text-ncrst-gold">Industry</h4>
                </div>
                <p className="text-sm opacity-90">Technology transfer and commercialization partnerships</p>
              </div>
              <div className="text-center">
                <div className="bg-white/10 p-4 rounded-lg mb-3">
                  <h4 className="font-bold text-ncrst-gold">Government</h4>
                </div>
                <p className="text-sm opacity-90">Policy development and digital transformation initiatives</p>
              </div>
              <div className="text-center">
                <div className="bg-white/10 p-4 rounded-lg mb-3">
                  <h4 className="font-bold text-ncrst-gold">International</h4>
                </div>
                <p className="text-sm opacity-90">Global technology networks and knowledge exchange</p>
              </div>
            </div>
          </div>
        </div>
